        ...
        $(document).on('change', '.item', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $(el.parent().parent().find('.category_id')).val();
...
<div class="row">
    <?php echo e(Form::open(array('url' => 'invoice','class'=>'w-100', 'id'=>'form-id'))); ?>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="form-group" id="customer-box">
                            ...
                            <?php echo e(Form::select('customer_id', $customers,$customerId, array('class' => 'form-control select','id'=>'customerr','data-url'=>route('invoice.customer'),'required'=>'required'))); ?>
            ...
            <div class="item-section py-4">
                <div class="row justify-content-between align-items-center">
                    <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                        <a  data-repeater-create="" class="btn btn-primary mr-2" data-toggle="modal" data-target="#add-bank">
                ...
                <div class="table-responsive">
                    <table class="table mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                        ...
                        <tr>
                            ...
                            <th class=""><?php echo e(__('Amount')); ?> <br><small class="text-danger font-weight-bold"><?php echo e(__('before tax & discount')); ?></small></th>
                            <th></th>
                            <th></th>
                        </tr>
                        </thead>
                        ...
                        <tr>
                            ...
                            <td class="d-none">
                                <div class="form-group price-input input-group search-form">
                                    <?php echo e(Form::text('discount','0', array('class' => 'form-control discount','placeholder'=>__('Discount')))); ?>
    ...
    <div class="modal-footer">
        ...
        <input type="button" onclick="document.getElementById('form-id').submit();" value="<?php echo e(__('Create')); ?>" class="btn  btn-primary">
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sr-traders\resources\views/invoice/create.blade.php ENDPATH**/ ?>
...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-12">
            <?php echo e(Form::label('discription', __('Discription'),['class'=>'form-label'])); ?>

            <?php echo e(Form::text('discription', '', array('class' => 'form-control','required'=>'required'))); ?>
...
<?php /**PATH C:\laragon\www\accountgo\resources\views/productServiceCategory/create.blade.php ENDPATH**/ ?>
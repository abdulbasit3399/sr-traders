                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                ...
                                <?php echo e(Form::select('customer_id', $customers,null, array('class' => 'form-control select ','id'=>'customerr','data-url'=>route('invoice.customer'),'required'=>'required'))); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td class="d-none">
                                <div class="form-group price-input input-group search-form">
                                        <?php echo e(Form::text('discount',0, array('class' => 'form-control discount','required'=>'required','placeholder'=>__('Discount')))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sr-traders\resources\views/invoice/edit.blade.php ENDPATH**/ ?>
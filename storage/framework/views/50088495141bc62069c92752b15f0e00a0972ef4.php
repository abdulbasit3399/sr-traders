...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::open(array('url' => 'invoice/returnstore','class'=>'w-100'))); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            <?php echo e(Form::date('return_date',null,array('class'=>'form-control','required'=>'required'))); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table  mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="form-group">
                                        <?php echo e(Form::textarea('description', null, ['class'=>'form-control description','rows'=>'2','placeholder'=>__('Description')])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sr-traders\resources\views/InvoiceReturn/create.blade.php ENDPATH**/ ?>
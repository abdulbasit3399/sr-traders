<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage Invoice Returns')); ?>
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <?php endif; ?>
    <li class="breadcrumb-item"><?php echo e(__('Invoice Return')); ?></li>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create invoice')): ?>
            <a href="<?php echo e(route('InvoiceReturn.create', 0)); ?>" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sr-traders\resources\views/InvoiceReturn/index.blade.php ENDPATH**/ ?>
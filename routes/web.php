...
Route::prefix('customer')->as('customer.')->group(
    function () {
        ...
        // Route::get('return', 'InvoiceController@invoiceReturn')->name('return')->middleware(
        //     [
        //         'auth:customer',
        //         'XSS', 'revalidate',
        //     ]
...
Route::get('invoice/returnIndex', 'InvoiceController@returnIndex')->name('invoice.returnIndex')->middleware(
    [
        'auth',
    ]
);

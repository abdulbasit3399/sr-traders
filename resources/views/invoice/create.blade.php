...
@section('content')
<div class="row">
    {{ Form::open(array('url' => 'invoice','class'=>'w-100', 'id'=>'form-id')) }}
    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="form-group" id="customer-box">
                            ...
                            {{ Form::select('customer_id', $customers,$customerId, array('class' => 'form-control select','id'=>'customerr','data-url'=>route('invoice.customer'),'required'=>'required')) }}
                ...
                <div class="table-responsive">
                    <table class="table mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                        ...
                        <tr>
                            ...
                            {{--  <th>{{__('Tax')}} (%)</th>  --}}
                            {{--  <th>{{__('Discount')}}</th>  --}}
                            <th class="">{{__('Amount')}} <br><small class="text-danger font-weight-bold">{{__('before tax & discount')}}</small></th>
                            <th></th>
                            <th></th>
                        </tr>
                        </thead>
                        ...
                        <tr>
                            <td width="25%" class="form-group pt-0">
                                {{ Form::select('category_id', $category,null, array('class' => 'form-control select category_id','required'=>'required','data-id' => $category)) }}
                            </td>

                            <td width="25%" class="form-group pt-0">
                                {{--  {{ Form::select('item', $product_services,'', array('class' => 'form-control select2 item result-sort','data-url'=>route('invoice.product'),'required'=>'required')) }}  --}}
                            ...
                            <td class="d-none">
                                <div class="form-group price-input input-group search-form">
                                    {{ Form::text('discount','0', array('class' => 'form-control discount','placeholder'=>__('Discount'))) }}
                                    <span class="input-group-text bg-transparent">{{\Auth::user()->currencySymbol()}}</span>
                                </div>
                            </td>
    ...
    <div class="modal-footer">
        ...
        <input type="button" onclick="document.getElementById('form-id').submit();" value="{{__('Create')}}" class="btn  btn-primary">
    </div>
    {{ Form::close() }}

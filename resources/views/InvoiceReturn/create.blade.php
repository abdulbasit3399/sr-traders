...
@section('page-title')
    {{__('Invoice Return Create')}}
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item"><a href="{{route('invoice.index')}}">{{__('Invoice')}}</a></li>
    <li class="breadcrumb-item"><a href="#">{{__('Return')}}</a></li>
...
@section('content')
    <div class="row">
        {{ Form::open(array('url' => 'invoice/returnstore','class'=>'w-100')) }}
        {{--  <form action="{{ route('invoice.returnstore') }}" method="POST" class="w-100">  --}}
        <div class="col-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            {{Form::date('return_date',null,array('class'=>'form-control','required'=>'required'))}}
